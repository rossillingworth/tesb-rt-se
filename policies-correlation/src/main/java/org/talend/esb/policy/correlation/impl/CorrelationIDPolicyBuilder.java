...
public class CorrelationIDPolicyBuilder implements AssertionBuilder<Element> {
	...
	public static final String CORRELATION_ID_SCHEMA_NAME = "CorrelationID";

	public static final QName CORRELATION_ID_SCHEMA = new QName(NAMESPACE, CORRELATION_ID_SCHEMA_NAME);
	...
	public QName[] getKnownElements() {
		return new QName[]{CORRELATION_ID_SCHEMA};
	}
}
