...
public class CallContextStoreRestServiceSecurityProvider extends AbstractRestSecurityProvider {
    ...
    public void init() {
        ...
        if (Authentication.NO == callContextStoreAuthentication) {
            return;
        }
    ...
    public void setCallContextStoreEndpoint(JAXRSServerFactoryBean server) {
        this.server = server;
    }
