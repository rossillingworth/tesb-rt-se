 ...
 * under the License.
 */
package org.talend.esb.transport.jms.wsdl11;
...
import org.talend.esb.transport.jms.uri.JMSEndpoint;
import org.talend.esb.transport.jms.uri.JMSEndpointParser;
    ...
    protected JMSConfiguration configureEndpoint(boolean isConduit, JMSEndpoint endpoint) {
        ...
        if (jmsConfig.isUsingEndpointInfo()) {
            ...
            if (useJndi) {
                ...
                pubSubDomain = endpoint.getJmsVariant().contains(JMSURIConstants.TOPIC);
                ...
                jmsConfig.setSubscriptionDurable((endpoint.getDurableSubscriptionName() != null));
